...
const dfs = (
	...
	resources: Record<Resource, number> = { ore: 0, clay: 0, obsidian: 0, geode: 0 }
): number => {
...
console.log('Part 1:', input.reduce((acc, _, i) => acc + dfs(24, i) * (i + 1), 0));
console.log('Part 2:', input.slice(0, 3).reduce((acc, _, i) => acc * dfs(32, i), 1));